    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, unique=True)),
                ('status', models.CharField(choices=[('Lager', 'Lager'), ('Unterwegs', 'Unterwegs')], max_length=255)),
                ('druckerfuellstand', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255, unique=True)),
                ('image', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='pit.festplattenimage')),
                ('kurs', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pit.kurs')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='kurs',
            name='trainer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pit.trainer'),
        ),
    ]
